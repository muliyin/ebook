const actions = {
	...
	setTitleVisible: (context, titleVisible) => {
		return context.commit('SET_TITLEVISIBLE', titleVisible)
	},
	...
	setDefaultFontSize: (context, defaultFontSize) => {
		return context.commit('SET_SETTINGVISIBLE', defaultFontSize)
	},
